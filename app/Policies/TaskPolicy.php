...
class TaskPolicy
{
    ...
    /**
     * Determine whether the user can create Tasks For other users.
     */
    public function createForAllUsers(User $user): bool
    {
        return $user->isAdmin();
    }

    public function createForSelf(User $user): bool
    {
        return true;
    }
